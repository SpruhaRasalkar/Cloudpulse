...
<head>
    ...
    <style>
        ...
        .btn-midnight:hover {
            background-color: #000080; /* Optional darker midnight blue on hover */
        }
    ...
    <div class="form-section">
        ...
        <form method="POST">
            ...
            <div class="d-grid gap-2">
                <button type="submit" class="btn btn-midnight btn-icon"><span>🚀</span> Generate Report</button>
            </div>
        </form>
    </div>
        ...
        <div class="mt-5">
            ...
            <div class="table-responsive">
                ...
                <div class="mt-3 d-grid">
                    <button id="exportCsv" class="btn btn-outline-midnight btn-icon"><span>⬇️</span> Export CSV</button>
                </div>
            </div>
        </div>
...
<script>
    $(document).ready(function () {
        ...
        const table = $('#healthTable').DataTable({
            pageLength: 10,
            lengthChange: false,
            ordering: true,
            dom: 'Bfrtip',
